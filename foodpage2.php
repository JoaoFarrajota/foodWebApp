    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <div class="col-lg-12 text-center">
          ...
          <form action="foodpage2.php" name="select" method="post">
                                                 ...
                                                 <div class='modal-dialog'>
                                                      ...
                                                      <div class='modal-content'>
                                                          ...
                                                          <div class='modal-body'>
                                                            ...
                                                            <button type='button' disabled class='btn btn-primary btn-sm btn-block' data-toggle=\"collapse\" data-target=\"#demo\"   >Comprar</button>
                                                                <div id='demo' class='collapse'><br>
                                                                    <form action='registoCompra.php'>
                                                                        <p class='color_p'>Agendar a sua entrega</p>
                                                                        <input name='data_entrega' type='date' class='form-control' id='email' placeholder='Data de entrega' required><br>
                                                                        <input name='hora_entrega' type='time' class='form-control' id='pwd' placeholder='Hora de entrega' required><br>
                                                                        <input name='quantidades' type='text' class='form-control' id='pwd' placeholder='Quantidades' required><br>
                                                                        <button class='btn btn-primary btn-sm'data-toggle=\"collapse\" data-target=\"#demo\" disabled>Confirmar compra</button>
                                                                    </form>
                                                                </div>
                                                                <p>Para realizar uma compra necessita de efetuar o Login.</p>
                                                            </div>
                                                            
                                                          <div class='modal-footer'>
                                                              <p>Caso não possua uma conta terá de se registar. </p>
                                                              <button type='button' class='btn btn-default' data-dismiss='modal'>Fechar</button>
                                                         </div>
                                                      </div>
                                                  </div>
                                  ...
                                  if ($resultCheck > 0) {
                                      while ($row = mysqli_fetch_array($result)) {
                                          ...
                                          echo "<div class='responsive'>
                                                      <div class='gallery'>
                                                        <div class='desc'>
                                                            <img class='useravatar' src='profileImagem/{$row2[0]}' height='50' width='50'>
