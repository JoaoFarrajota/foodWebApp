...
<body class="fundo_cor">
  ...
  <!-- Modal para o Histórico de compras-->
  <div id="modal_Hcompras" class="modal fade  " role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          $sql2 = "SELECT data_entrega , nome_prato , preco , quant_comprada FROM hvendas WHERE comprador ='$userId' ";
  ...
  <div class="container">
    <div class="row">
          ...
          <div class="container">
            ...
            <div class="tagsDaInfo">
                ...
                <img src=<?php echo $avatarUploaded; ?> alt="" height="160" width="160" class="Uploadeduseravatar" >
                  ...
                  <h3>Página de apenas consumidor !!!</h3>
                  ...
                  <div class="botoes">
                    ...
                    <button class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#modal_Hcompras" > Histórico de compras </button>
      ...
      $sqlzorro = "SELECT nickname FROM utilizador WHERE tipo !='consumidor'  ";
